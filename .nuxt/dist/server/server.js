...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(6).default("49bb9be4", content, true)
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html{box-sizing:border-box;-webkit-font-smoothing:antialiased;-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);overflow-x:hidden;background:#f7f7f7;width:100%;height:100%;font-size:16px;font-family:\"Barlow\",\"Roboto\",\"calibri\",sans-serif}*,:after,:before{box-sizing:inherit}a,button{transition:all .15s}body{margin:auto;position:relative;font-weight:300;color:#323232;background-color:#fff;line-height:1.15em;width:100%;height:100%}h1,h2,h3,h4,h5{font-family:\"barlow Semi Condensed\",\"roboto Condensed\",\"Barlow Condensed\",\"arial narrow\",sans-serif;line-height:1.15em}h1:first-letter,h2:first-letter,h3:first-letter,h4:first-letter,h5:first-letter{text-transform:capitalize}h1{font-size:48px;text-transform:uppercase;font-weight:400;margin-bottom:24px;text-align:center}h2{font-size:32px;margin:32px 0 16px;color:#8ac486}h2,h3{font-weight:300}h3{font-size:24px;margin:24px 0;color:#dc6455}h4{font-size:16px;color:#7997b5;text-transform:uppercase}h4,li,p{font-weight:300}li,p{margin-top:0;margin-bottom:8px;line-height:1.5em}a,a:hover{text-decoration:none;color:inherit}a{color:#fff;display:block;text-align:left}a:before{content:\"➜ \";padding-left:4px}a.space{margin-bottom:12px}a.ib{display:inline-block;color:#dc6455}h3.red{margin-top:32px;color:#e27f73}.red{color:#dc6455}small{font-size:80%}sub,sup{position:relative;font-size:75%;line-height:0;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}a:focus,button:focus,div:focus,i:focus,img:focus,li:focus,p:focus,span:focus,strong:focus,ul:focus{outline:0 auto -webkit-focus-ring-color;outline-color:-webkit-focus-ring-color;outline-style:none}button{border:none;background-color:transparent;cursor:pointer}.date{font-family:monospace;font-size:.75em}code{background-color:rgba(0,0,0,.1);box-shadow:inset 0 0 16px 0 rgba(0,0,0,.2);border-radius:2px;padding:24px;font-size:13px;width:100%;display:block;margin:16px 0;line-height:24px;word-break:break-word}code .p24{padding-left:24px;color:#8ac486}code .p12{padding-left:12px}code span{margin-bottom:16px;color:#f7f7f7}code{font-family:monospace}code span{display:block}blockquote{font-style:italic;border-left:4px solid hsla(0,0%,100%,.1);margin-left:0;padding-left:16px}img{margin-right:8px}.intro{width:30%}.rounded{border-radius:30%}.flexVC{display:flex;align-items:center}.justifySA{justify-content:space-around}.mb32{margin-bottom:32px}.mt32{margin-top:32px}.preambule{font-weight:500;padding:12px;border:4px solid hsla(0,0%,100%,.1)}#__layout,#__nuxt{width:100%;height:100%}#faviKon{text-align:left;background-color:#1f2c39;color:#fff;flex-direction:column;padding:24px}#faviKon .content{width:100%;max-width:980px;margin:auto}.go-up{transform:rotate(-90deg);position:fixed;height:48px;width:48px;display:flex;align-items:center;justify-content:center;bottom:0;right:0;border-radius:50%;background-color:#2c3e50;margin:16px}.go-up a:before{color:#8ac486;margin:0;padding:0;font-size:24px}.tests{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;box-shadow:inset 0 0 16px 0 rgba(0,0,0,.1);margin-top:32px;background-color:#f7f7f7;color:#505050;padding:24px;border-radius:4px}.tests h2{margin-top:0;color:#527495;font-family:\"barlow Semi Condensed\",\"roboto Condensed\",\"Barlow Condensed\",\"arial narrow\",sans-serif;text-transform:uppercase}.tests a{margin:0 4px;display:inline-block;color:#dc6455}.tests img{margin-right:8px;max-width:calc(25% - 8px)}.tests img.initial{max-width:100%}.tests h4:first-of-type{margin-top:0}.tests#Test{font-size:.95em}.tests#Test li{line-height:1.15em;margin-bottom:4px}.tests#Test h4{color:#505050;border-left:2px solid rgba(0,0,0,.1);padding-left:12px}.px16{width:16px;height:16px}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _initialState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _initialState__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_initialState__WEBPACK_IMPORTED_MODULE_0__);
// import Vue from 'vue'
...
const _efdd824c = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 34)));
...
// EXTERNAL MODULE: ./assets/style/main.sass
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(11), 'initialState.js'); // If the environment supports hot reloading...
})(); // createStore
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "name": "description",
        "content": "A guide for Favicon & App Icons"
      }, {
        "name": "keywords",
        "content": "Favicon, App Icon, PWA, browserconfig, mstiles, tiles, android, ios, splashscreen, chrome"
      }, {
        "property": "og:url",
        "content": "https:\u002F\u002Ffavikon-b2ba4.web.app\u002F"
      }, {
        "property": "og:title",
        "content": "FavAppIkon"
      }, {
        "property": "og:description",
        "content": "A guide for Favicons and Progressive Web App Icons"
      }, {
        "property": "og:image",
        "content": "\u002Fog.png"
      }, {
      ...
      "link": [{
        ...
        "rel": "apple-touch-icon",
        "sizes": "192x192",
        "href": "\u002Fandroid\u002Fmobile-favicon-192.png"
      }, {
        "rel": "shortcut icon",
        "sizes": "192x192",
        "href": "\u002Fandroid\u002Fmobile-favicon-192.png"
        ...
        "href": "\u002Fsplashscreens\u002Fiphone12_splash.png",
        "media": "(device-width: 390px) and (device-height: 884px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)",
        "rel": "apple-touch-startup-image"
      }, {
        "href": "\u002Fsplashscreens\u002Fiphone12max_splash.png",
        ...
        "rel": "manifest",
        "href": "\u002F_nuxt\u002Fmanifest.f9b350a9.json",
        "hid": "manifest"
      }],
      "script": [],
      "style": []
